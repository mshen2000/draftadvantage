...
@Subclass(index = true)
public class ProgramScoreMath extends ProgramScore implements Serializable {
	...
	public ProgramScoreMath() {

		this.programname = "Math";

	}

	public ProgramScoreMath(Long studentid) {
