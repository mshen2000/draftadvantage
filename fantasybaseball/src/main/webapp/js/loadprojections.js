...
function loadHitterProjectionTable(data, isInitialLoad)
{
	...
	var config = {
            ...
            "columns": [
                ...
                { "title": "Pos", "mData": "hitter_pos_elig_espn", "sDefaultContent": ""},
                { "title": "PA", "mData": "hitter_pa"},
                { "title": "Avg", "mData": "hitter_avg", render: $.fn.dataTable.render.number( ',', '.', 3 )},
                { "title": "HR", "mData": "hitter_hr", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "SB", "mData": "hitter_sb", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "Runs", "mData": "hitter_runs", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "RBI", "mData": "hitter_rbi", render: $.fn.dataTable.render.number( ',', '.', 0 )},
            ],
            "searchCols": [
               { "search": "H" },
...
function loadPitcherProjectionTable(data, isInitialLoad)
{
	...
	var config = {
            ...
            "columns": [
                ...
                { "title": "Age", "mData": "age" },
                { "title": "Team", "mData": "team"},
                { "title": "Pos", "mData": "pitcher_pos", "sDefaultContent": ""},
                { "title": "G", "mData": "pitcher_games", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "GS", "mData": "pitcher_gs", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "IP", "mData": "pitcher_ip", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "W", "mData": "pitcher_w", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "SV", "mData": "pitcher_sv", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "ERA", "mData": "pitcher_era", render: $.fn.dataTable.render.number( ',', '.', 2 )},
                { "title": "SO", "mData": "pitcher_k", render: $.fn.dataTable.render.number( ',', '.', 0 )},
                { "title": "BB", "mData": "pitcher_bb", render: $.fn.dataTable.render.number( ',', '.', 0 )},
            ],
            "searchCols": [
               { "search": "P" },
               null,null,null,null,null,
